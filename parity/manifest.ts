...
export const PARITY_MANIFEST = {
  ...
  entries: [
    ...
    },
    {
      ...
      module: "core",
      notes:
        "All scalar depths, channels, and flip codes return a new matrix; destination mutation remains.",
      patentReview: "required",
      sources: [CORE_ARRAY_SOURCE],
      status: "partial",
      upstream: "cv.flip",
    ...
    },
    {
      ...
      module: "core",
      notes:
        "All scalar depths and channels with positive repeat counts; destination mutation remains.",
      patentReview: "required",
      sources: [CORE_ARRAY_SOURCE],
      status: "partial",
      upstream: "cv.repeat",
    ...
    },
    {
      ...
      method: "rotate",
      module: "core",
      notes: "All scalar depths, channels, and three rotation codes; destination mutation remains.",
      patentReview: "required",
      sources: [CORE_ARRAY_SOURCE],
      status: "partial",
      upstream: "cv.rotate",
    ...
    },
    {
      ...
      method: "transpose",
      module: "core",
      notes: "All scalar depths and channels return a new matrix; destination mutation remains.",
      patentReview: "required",
      sources: [CORE_ARRAY_SOURCE],
      status: "partial",
