...
| `AKAZE.getDescriptorType`, `AKAZE.setDescriptorType`                                         | Matching `cv.AKAZE` descriptor-type methods                           | Enum-object behavior remains                             |
| `AKAZE.getDiffusivity`, `AKAZE.setDiffusivity`                                               | Matching `cv.AKAZE` diffusivity methods                               | Enum-object behavior remains                             |
